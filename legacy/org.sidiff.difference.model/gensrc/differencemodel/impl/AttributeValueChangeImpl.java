 ...
 * <ul>
 *   <li>{@link differencemodel.impl.AttributeValueChangeImpl#getObjA <em>Obj A</em>}</li>
 *   <li>{@link differencemodel.impl.AttributeValueChangeImpl#getObjB <em>Obj B</em>}</li>
 *   <li>{@link differencemodel.impl.AttributeValueChangeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AttributeValueChangeImpl extends ChangeImpl implements AttributeValueChange {
	...
	protected EClass eStaticClass() {
		return DifferencemodelPackage.Literals.ATTRIBUTE_VALUE_CHANGE;
	}
		...
		if (objA != null && objA.eIsProxy()) {
			...
			if (objA != oldObjA) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DifferencemodelPackage.ATTRIBUTE_VALUE_CHANGE__OBJ_A, oldObjA, objA));
			}
		}
		return objA;
	}
	...
	public void setObjA(EObject newObjA) {
		...
		objA = newObjA;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DifferencemodelPackage.ATTRIBUTE_VALUE_CHANGE__OBJ_A, oldObjA, objA));
	}
	...
	public EObject getObjB() {
		if (objB != null && objB.eIsProxy()) {
			...
			if (objB != oldObjB) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DifferencemodelPackage.ATTRIBUTE_VALUE_CHANGE__OBJ_B, oldObjB, objB));
			}
		}
		return objB;
	}
	...
	public void setObjB(EObject newObjB) {
		...
		objB = newObjB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DifferencemodelPackage.ATTRIBUTE_VALUE_CHANGE__OBJ_B, oldObjB, objB));
	}
	...
	public EAttribute getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DifferencemodelPackage.ATTRIBUTE_VALUE_CHANGE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(EAttribute newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DifferencemodelPackage.ATTRIBUTE_VALUE_CHANGE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DifferencemodelPackage.ATTRIBUTE_VALUE_CHANGE__OBJ_A:
				if (resolve) return getObjA();
				return basicGetObjA();
			case DifferencemodelPackage.ATTRIBUTE_VALUE_CHANGE__OBJ_B:
				if (resolve) return getObjB();
				return basicGetObjB();
			case DifferencemodelPackage.ATTRIBUTE_VALUE_CHANGE__TYPE:
