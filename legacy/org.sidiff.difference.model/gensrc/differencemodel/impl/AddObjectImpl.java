 ...
 * <ul>
 *   <li>{@link differencemodel.impl.AddObjectImpl#getObj <em>Obj</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddObjectImpl extends ChangeImpl implements AddObject {
	...
	protected EClass eStaticClass() {
		return DifferencemodelPackage.Literals.ADD_OBJECT;
	}
		...
		if (obj != null && obj.eIsProxy()) {
			...
			if (obj != oldObj) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DifferencemodelPackage.ADD_OBJECT__OBJ, oldObj, obj));
			}
		}
		return obj;
	}
	...
	public void setObj(EObject newObj) {
		...
		obj = newObj;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DifferencemodelPackage.ADD_OBJECT__OBJ, oldObj, obj));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DifferencemodelPackage.ADD_OBJECT__OBJ:
