...
public class RecognitionEngineStatistics implements IRecognitionEngineStatistics {
	 ...
	 */
	public boolean MEASURE_GRAPH_SIZE = true;
	 ...
	 */
	private void analyseEGraphs(LiftingGraphFactory liftingGraphFactory, Collection<Rule> recognitionRules) {
	 ...
	 */
	private void analyseEGraph(LiftingGraphFactory liftingGraphFactory, Rule recognitionRule) {
		if (!STATISTICS) {
			return;
		}
