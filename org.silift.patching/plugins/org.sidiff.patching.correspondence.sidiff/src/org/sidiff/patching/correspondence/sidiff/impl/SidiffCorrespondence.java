...
import org.sidiff.core.matching.DerivedIDMatchingService;
...
public class SidiffCorrespondence {
	...
	public void initialize() {
		...
		context.putService(ServiceHelper.getService(bundleContext, IterativeMatchingService.class, documentType,
				ServiceHelper.DEFAULT));
		context.putService(ServiceHelper.getService(bundleContext, DerivedIDMatchingService.class, documentType,
				ServiceHelper.DEFAULT));
		...
		context.getService(DerivedIDMatchingService.class).match();
