...
public class QualifiedArgumentNameHandler extends AbstractHandler{
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		try {
			...
			patchView.toggleQualifiedArgumentNames(!HandlerUtil.toggleCommandState(event.getCommand()));
