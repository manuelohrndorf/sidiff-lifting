 ...
 * @generated NOT
 */
public class TransientProfiledSymmetricDifferenceItemProvider extends ItemProviderAdapter
implements 
...
IItemPropertySource
{
	...
	protected ProfiledSymmetricDifference difference;
	 ...
	 * @generated NOT
	 */
	public TransientProfiledSymmetricDifferenceItemProvider(
			AdapterFactory adapterFactory, ProfiledSymmetricDifference psd) {
		super(adapterFactory);
		psd.eAdapters().add(this);
		difference = psd;
	}
