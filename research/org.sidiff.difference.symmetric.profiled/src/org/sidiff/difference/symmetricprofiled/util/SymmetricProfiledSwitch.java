 ...
 * @generated
 */
public class SymmetricProfiledSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public SymmetricProfiledSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SymmetricProfiledPackage.APPLIED_STEREOTYPE: {
