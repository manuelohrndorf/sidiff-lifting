...
public class ExecutableModelSliceImpl extends ModelSliceImpl implements ExecutableModelSlice {
			...
			if (asymmetricDifference != oldAsymmetricDifference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RuleBasedSlicePackage.EXECUTABLE_MODEL_SLICE__ASYMMETRIC_DIFFERENCE,
							oldAsymmetricDifference, asymmetricDifference));
			}
		}
	...
	public void setAsymmetricDifference(AsymmetricDifference newAsymmetricDifference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RuleBasedSlicePackage.EXECUTABLE_MODEL_SLICE__ASYMMETRIC_DIFFERENCE, oldAsymmetricDifference,
	...
	public void serialize(String path, final boolean zip) {
		...
		String symmetricdiff_name = "ExecutableSliceA." + AsymmetricDiffFacade.SYMMETRIC_DIFF_EXT;
	
		String asymmetricdiff_name = "ExecutableSliceS." + AsymmetricDiffFacade.ASYMMETRIC_DIFF_EXT;
