package org.sidiff.difference.symmetric.profiled.editor;
...
public class SymmetricProfiledViewer extends ContentViewer {
	...
	public SymmetricProfiledViewer(ComposedAdapterFactory adapterFactory) {
		super();
