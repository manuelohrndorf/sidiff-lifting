...
public class ConfigurationAdapterFactory extends AdapterFactoryImpl {
	...
	protected ConfigurationSwitch<Adapter> modelSwitch =
		new ConfigurationSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSlicedEReference(SlicedEReference object) {
				return createSlicedEReferenceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.sidiff.slicer.structural.configuration.SlicingConfiguration <em>Slicing Configuration</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.sidiff.slicer.structural.configuration.SlicedEClass <em>Sliced EClass</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.sidiff.slicer.structural.configuration.Constraint <em>Constraint</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.sidiff.slicer.structural.configuration.SlicedEReference <em>Sliced EReference</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSlicedEReferenceAdapter() {
		return null;
	}
