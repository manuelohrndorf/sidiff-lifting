 ...
 * <!-- end-user-doc -->
 * @see org.sidiff.slicing.configuration.ConfigurationPackage#getSlicingMode()
 * @model
 * @generated
 */
public enum SlicingMode implements Enumerator {
	...
	/**
	 * The '<em><b>PESSIMISTIC</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	PESSIMISTIC(1, "PESSIMISTIC", "PESSIMISTIC");
	...
	/**
	 * The '<em><b>PESSIMISTIC</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>PESSIMISTIC</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #PESSIMISTIC
	...
	public static SlicingMode get(int value) {
		switch (value) {
			...
			case PESSIMISTIC_VALUE: return PESSIMISTIC;
		}
		return null;
	}
