...
import sample.mm.refined.samplemm.SamplemmFactory;
...
public class SamplemmPackageImpl extends EPackageImpl implements SamplemmPackage {
	 ...
	 * @generated
	 */
	private EClass item_LinkEClass = null;
	 ...
	 * @see sample.mm.refined.samplemm.SamplemmPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getNCList_Item_links() {
		return (EReference)ncListEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getItem_Succ() {
	 ...
	 * @generated
	 */
	public EClass getItem_Link() {
		return item_LinkEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getItem_Link_Pre() {
		return (EReference)item_LinkEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getItem_Link_Succ() {
		return (EReference)item_LinkEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(ncListEClass, NC_LIST__ITEM_LINKS);

		itemEClass = createEClass(ITEM);
		createEAttribute(itemEClass, ITEM__NAME);
		createEReference(itemEClass, ITEM__PRE);
		createEReference(itemEClass, ITEM__SUCC);
		...
		item_LinkEClass = createEClass(ITEM_LINK);
		createEReference(item_LinkEClass, ITEM_LINK__PRE);
		createEReference(item_LinkEClass, ITEM_LINK__SUCC);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getNCList_Item_links(), this.getItem_Link(), null, "Item_links", null, 0, -1, NCList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getItem_Pre(), this.getItem(), this.getItem_Succ(), "pre", null, 0, 1, Item.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getItem_Succ(), this.getItem(), this.getItem_Pre(), "succ", null, 0, 1, Item.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(item_LinkEClass, Item_Link.class, "Item_Link", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getItem_Link_Pre(), this.getItem(), null, "pre", null, 1, 1, Item_Link.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getItem_Link_Succ(), this.getItem(), null, "succ", null, 1, 1, Item_Link.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
