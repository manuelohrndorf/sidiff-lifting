...
public class SamplemmFactoryImpl extends EFactoryImpl implements SamplemmFactory {
	...
	public static SamplemmFactory init() {
		try {
			SamplemmFactory theSamplemmFactory = (SamplemmFactory)EPackage.Registry.INSTANCE.getEFactory("http://samplemm/1.0/refined"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SamplemmPackage.ITEM_LINK: return createItem_Link();
			default:
	 ...
	 * @generated
	 */
	public Item_Link createItem_Link() {
		Item_LinkImpl item_Link = new Item_LinkImpl();
		return item_Link;
	}
