 ...
 *
 */
public class RemoteConnectorPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public void init(IWorkbench workbench) {
		setPreferenceStore(new ScopedPreferenceStore(InstanceScope.INSTANCE, ConnectorUIPlugin.PLUGIN_ID));
	...
	protected Control createContents(Composite parent) {
		...
		this.uri_field = new StringFieldEditor(PreferenceConstants.P_URL, "URL", this.uri_group);
		this.uri_field.setPage(this);
		this.uri_field.setPreferenceStore(getPreferenceStore());
		this.uri_field.load();
		
		this.port_field = new IntegerFieldEditor(PreferenceConstants.P_Port, "Port", this.uri_group);
		...
		this.user_field = new StringFieldEditor(PreferenceConstants.P_USER, "User", this.auth_group);
		this.user_field.setPage(this);
		this.user_field.setPreferenceStore(getPreferenceStore());
		this.user_field.load();
		
		this.password_field = new StringFieldEditor(PreferenceConstants.P_PASSWORD, "Password", this.auth_group);
