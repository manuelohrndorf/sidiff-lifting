 ...
 * @generated
 */
public class SymboliclinkSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SymboliclinkPackage.SYMBOLIC_LINKS: {
				SymbolicLinks symbolicLinks = (SymbolicLinks)theEObject;
				T result = caseSymbolicLinks(symbolicLinks);
			...
			case SymboliclinkPackage.EXTERNAL_SYMBOLIC_LINK_OBJECT: {
				ExternalSymbolicLinkObject externalSymbolicLinkObject = (ExternalSymbolicLinkObject)theEObject;
				T result = caseExternalSymbolicLinkObject(externalSymbolicLinkObject);
				if (result == null) result = caseSymbolicLinkObject(externalSymbolicLinkObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Symbolic Links</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Symbolic Links</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSymbolicLinks(SymbolicLinks object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>External Symbolic Link Object</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>External Symbolic Link Object</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
