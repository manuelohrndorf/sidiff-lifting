...
import org.sidiff.difference.asymmetric.util.AsymmetricUtil;

/**
 * This is the action bar contributor for the Asymmetric model editor. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class AsymmetricActionBarContributor
	...
	protected IAction showPropertiesViewAction =
			new Action(
					AsymmetricEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
				@Override
				public void run() {
					try {
...
//			new Action(AsymmetricEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
//				@Override
...
//	protected IMenuManager createSiblingMenuManager;
	 ...
	 * @generated
	 */
	public AsymmetricActionBarContributor() {
...
//		toolBarManager.add(new Separator("asymmetric-settings"));
//		toolBarManager.add(new Separator("asymmetric-additions"));
	}
...
//				AsymmetricEditorPlugin.INSTANCE.getString("_UI_AsymmetricEditor_menu"),
//				"org.sidiff.difference.asymmetricMenuID");
...
//				AsymmetricEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
//		submenuManager.insertBefore("additions", createChildMenuManager);
//
//		// Prepare for CreateSibling item addition or removal.
//		//
//		createSiblingMenuManager = new MenuManager(
//				AsymmetricEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
...
//		menuManager.insertBefore("edit", submenuManager);
		...
		// Disable/Enable Operation Invocation:
		if (getFirstSelection() instanceof OperationInvocation) {
			menuManager.add(getDisableOperationHandler());
		}
	...
	private IAction getDisableOperationHandler() {
		IAction disableOperationHandler =
				new Action("Enabled", IAction.AS_CHECK_BOX) {
			
					@Override
					public boolean isChecked() {
						Object firstSelection = getFirstSelection();
						if (firstSelection instanceof OperationInvocation) {
							return ((OperationInvocation) firstSelection).isApply();
						}
						return false;
					};
					...
					public void run() {
						Object firstSelection = getFirstSelection();
						if (firstSelection instanceof OperationInvocation) {
							OperationInvocation op = (OperationInvocation) firstSelection;
							if (op.isApply()) {
								AsymmetricUtil.disable(op);
							} else {
								AsymmetricUtil.enable(op);
							}	
						}
					}
				};
		return disableOperationHandler;
	}
