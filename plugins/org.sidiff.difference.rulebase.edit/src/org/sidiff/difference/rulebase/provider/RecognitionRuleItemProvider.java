 ...
 * @generated
 */
public class RecognitionRuleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RulebasePackage.Literals.RECOGNITION_RULE__RECOGNITION_MAIN_UNIT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addEditRulePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RecognitionRule_editRule_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RecognitionRule_editRule_feature", "_UI_RecognitionRule_type"),
				 RulebasePackage.Literals.RECOGNITION_RULE__EDIT_RULE,
				 true,
				 false,
				 true,
				 null,
