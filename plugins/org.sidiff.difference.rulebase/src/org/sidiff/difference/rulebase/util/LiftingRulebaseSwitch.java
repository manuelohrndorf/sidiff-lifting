 ...
 * @generated
 */
public class LiftingRulebaseSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static LiftingRulebasePackage modelPackage;
	 ...
	 * @generated
	 */
	public LiftingRulebaseSwitch() {
		if (modelPackage == null) {
			modelPackage = LiftingRulebasePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LiftingRulebasePackage.RECOGNITION_RULE: {
				RecognitionRule recognitionRule = (RecognitionRule)theEObject;
				T result = caseRecognitionRule(recognitionRule);
				if (result == null) result = caseEditRuleAttachment(recognitionRule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LiftingRulebasePackage.TRACE: {
