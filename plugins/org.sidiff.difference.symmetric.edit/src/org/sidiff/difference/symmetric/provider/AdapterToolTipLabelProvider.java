...
public class AdapterToolTipLabelProvider extends ColumnLabelProvider implements ILabelProvider, ITableLabelProvider, INotifyChangedListener
{
   ...
   */
  public static class ColorProvider extends AdapterToolTipLabelProvider implements IColorProvider, ITableColorProvider
  {
    /**
   ...
   */
  public static class FontAndColorProvider extends AdapterToolTipLabelProvider implements IColorProvider, IFontProvider, ITableColorProvider, ITableFontProvider
  {
    /**
...
public String getToolTipText(Object element) {
		...
		if(element instanceof SemanticChangeSet){
			...
			text = String.format("%s (%s -> %s)", LabelUtil.getLabel(((AddReference)element).getType()),
					LabelUtil.getToolTipLabel(((AddReference)element).getSrc()),
					LabelUtil.getToolTipLabel(((AddReference)element).getTgt()));
		}
		else if(element instanceof RemoveReference){
			text = String.format("%s (%s -> %s)", LabelUtil.getLabel(((RemoveReference)element).getType()),
					LabelUtil.getToolTipLabel(((RemoveReference)element).getSrc()),
					LabelUtil.getToolTipLabel(((RemoveReference)element).getTgt()));
		}
