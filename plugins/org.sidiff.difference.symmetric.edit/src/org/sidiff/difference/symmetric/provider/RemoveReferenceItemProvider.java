...
public class RemoveReferenceItemProvider
	...
	public String getText(Object object) {
		if(object instanceof RemoveReference){
			return String.format("%s: %s (%s -> %s)", getString("_UI_RemoveReference_type"), LabelUtil.getLabel(((RemoveReference) object).getType()), LabelUtil.getLabel(((RemoveReference) object).getSrc()), LabelUtil.getLabel(((RemoveReference) object).getTgt()));
		}
		return getString("_UI_RemoveReference_type");
	}
