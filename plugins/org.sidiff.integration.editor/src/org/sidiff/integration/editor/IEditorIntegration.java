...
public interface IEditorIntegration extends IExtension {

	Description<IEditorIntegration> DESCRIPTION = Description.of(IEditorIntegration.class,
			"org.sidiff.integration.editor", "editor", "class");

	EditorIntegrationManager MANAGER = new EditorIntegrationManager(DESCRIPTION);
