 ...
 */
public class DifferenceDomainMap {
	...
	/**
	 * Creates a new {@link DifferenceDomainMap}.
	 * 
	 * @param difference
	 *            The difference containing the changes.
	 */
	public DifferenceDomainMap(SymmetricDifference difference) {
	...
	public List<EObject> getAddObjectDomain(EClass type) {
		return new ArrayList<EObject>(internalGetAddObjectDomain(type));
	}
	...
	public int getAddObjectDomainSize(EClass type) {
		return internalGetAddObjectDomain(type).size();
	}
	...
	public List<EObject> getRemoveObjectDomain(EClass type) {
		List<EObject> domain = new ArrayList<EObject>(internalGetRemoveObjectDomain(type));

		if (subTypes != null) {
			for (EClass subtype : getSubTypes(type)) {
				domain.addAll(internalGetRemoveObjectDomain(subtype));
			}
		}
		return domain;
	}
	...
	public int getRemoveObjectDomainSize(EClass type) {
		int domainSize = internalGetRemoveObjectDomain(type).size();

		if (subTypes != null) {
			for (EClass subtype : getSubTypes(type)) {
				domainSize += internalGetRemoveObjectDomain(subtype).size();
			}
		}
		return domainSize;
	}
	...
	public List<EObject> getAddReferenceDomain(EReference type) {
		return new ArrayList<EObject>(internalGetAddReferenceDomain(type));
	}
	...
	public int getAddReferenceDomainSize(EReference type) {
		return internalGetAddReferenceDomain(type).size();
	}
	...
	public List<EObject> getRemoveReferenceDomain(EReference type) {
		return new ArrayList<EObject>(internalGetRemoveReferenceDomain(type));
	}
	...
	public int getRemoveReferenceDomainSize(EReference type) {
		return internalGetRemoveReferenceDomain(type).size();
	}
	...
	public List<EObject> getAttributeValueChangeDomain(EAttribute type) {
		return new ArrayList<EObject>(internalGetAttributeValueChangeDomain(type));
	}
	...
	public int getAttributeValueChangeDomainSize(EAttribute type) {
		return internalGetAttributeValueChangeDomain(type).size();
	}
