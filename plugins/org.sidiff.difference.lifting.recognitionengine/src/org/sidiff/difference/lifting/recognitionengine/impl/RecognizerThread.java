	...
	public void recognize() {
		...
		try {
			...
			for (Rule rr : recognitionRules) {
				...
				if (enableStatistic) {
					statistic.startSplitTimer(CREATE_GRAPH, "" + rr.hashCode(), rr.getName());
				}
				...
				if (enableStatistic) {
					statistic.startSplitTimer(MATCH_RR, "" + rr.hashCode(), rr.getName());
				}
				...
				if (enableStatistic) {
					statistic.stopSplitTimer(MATCH_RR, "" + rr.hashCode());
				}
