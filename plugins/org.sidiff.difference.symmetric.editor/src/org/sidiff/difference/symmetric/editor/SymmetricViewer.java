package org.sidiff.difference.symmetric.editor;
...
public class SymmetricViewer extends ContentViewer {
	...
	public SymmetricViewer(ComposedAdapterFactory adapterFactory) {
		super();
