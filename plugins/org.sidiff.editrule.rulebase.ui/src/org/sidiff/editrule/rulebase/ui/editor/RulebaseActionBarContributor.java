 ...
 * @generated
 */
public class RulebaseActionBarContributor
...
extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	 ...
	 * @generated
	 */
	public RulebaseActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("rulebase-settings"));
		toolBarManager.add(new Separator("rulebase-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager("Rulebase Editor", "rulebaseMenuID");
