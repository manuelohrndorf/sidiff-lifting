...
import static org.sidiff.common.henshin.HenshinConditionAnalysis.inNestedCondition;
...
public class TransformationPatterns {
	...
	public TransformationPatterns() {
		correspondencePatterns = new HashMap<>();
		addObjectPatterns = new HashMap<>();
		removeObjectPatterns = new HashMap<>();
		acObjectPatterns = new HashMap<>();
		addReferencePatterns = new HashMap<>();
		removeReferencePatterns = new HashMap<>();
		acReferencePatterns = new HashMap<>();
		acExtensionPatterns_acBoundary = new HashMap<>();
		acExtensionPatterns_lhsBoundary = new HashMap<>();
		acBoundaryNodePatterns = new HashMap<>();
		attributeValueChangePatterns = new HashMap<>();
	}
	...
	public Node getBoundaryTrace(Node editRuleACNode) {
		assert inNestedCondition(editRuleACNode) : "Not a nested condition node!";
	...
	public ACExtensionPattern getACExtensionPattern(Node editRuleACNode) {
		if (inNestedCondition(editRuleACNode)) {
