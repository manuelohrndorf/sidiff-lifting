...
public interface ITransformationEngine extends ITypedExtension {
	...
	TypedExtensionManager<ITransformationEngine> MANAGER =
	 ...
	 */
	void init(Resource targetResource, ExecutionMode executionMode, Scope scope);
	 ...
	 */
	Map<ParameterBinding, Object> execute(OperationInvocation operationInvocation, Map<ParameterBinding, Object> parameters)
	 ...
	 */
	void undo(OperationInvocation operationInvocation) throws OperationNotUndoableException;
}
