...
public class PatchSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PatchPackage.SETTING: {
				@SuppressWarnings("unchecked") Map.Entry<String, String> setting = (Map.Entry<String, String>)theEObject;
	 ...
	 * @generated
	 */
	public T caseSetting(Map.Entry<String, String> object) {
		return null;
	}
