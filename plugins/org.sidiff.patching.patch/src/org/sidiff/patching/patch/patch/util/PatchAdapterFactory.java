/**
 */
package org.sidiff.patching.patch.patch.util;
...
public class PatchAdapterFactory extends AdapterFactoryImpl {
	...
	protected PatchSwitch<Adapter> modelSwitch =
		new PatchSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSetting(Map.Entry<String, String> object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.sidiff.patching.patch.patch.Patch <em>Patch</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link java.util.Map.Entry <em>Setting</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
