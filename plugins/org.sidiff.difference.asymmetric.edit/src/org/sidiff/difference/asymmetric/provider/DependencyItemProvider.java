...
/**
 * This is the item provider adapter for a {@link org.sidiff.difference.asymmetric.Dependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DependencyItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AsymmetricPackage.Literals.DEPENDENCY__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AsymmetricPackage.Literals.DEPENDENCY__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AsymmetricPackage.Literals.DEPENDENCY__KIND,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		DependencyKind labelValue = ((Dependency)object).getKind();
