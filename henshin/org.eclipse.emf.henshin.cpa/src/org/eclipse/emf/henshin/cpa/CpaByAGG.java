...
public class CpaByAGG implements ICriticalPairAnalysis {
	...
	public void init(List<org.eclipse.emf.henshin.model.Rule> r1, List<org.eclipse.emf.henshin.model.Rule> r2,
		...
		// prevents to export a rule wice.
		...
		// *.ggx file generation
		exportModuleToAGG(workingPathWOExtension + ".ggx");
	...
	// this refactoring ofthe rules may be extractet into another class and rewritten as an Henshin inplace transformation 
