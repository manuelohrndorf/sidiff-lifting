...
public class Conflict extends CriticalPair {
	 ...
	 * @param minimalModel The minimal model on which both rules are applicable.
	 ...
	 */
	public Conflict(Rule r1, Rule r2, EGraph minimalModel, Match match1, Match match2, ConflictKind conflictKind) {
