...
public class Dependency extends CriticalPair {
	 ...
	 * @param minimalModel The minimal model after applying the first rule on which the second rule is applicable.
	 ...
	 */
	public Dependency(Rule r1, Rule r2, EGraph minimalModel, Match comatch, Match match, DependencyKind dependencyKind) {
