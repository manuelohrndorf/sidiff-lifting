...
(TK: Interessant. Der Ecore Editor selbst geht beim Verschieben einer eOpposite 
(d.h. das ein oder andere Ende wird zu einer anderen Klasse gezogen) so vor, daß
die eOpposite Beziehung zwischen den Referenzen aufgelöst wird).
evtl. kommt man mit minimaleren konsistenzerhaltenden Operationen aus)
*********************************************************************************
*********************************************************************************
The following transformations are deleted from the "generated" folder
