...
public abstract class AbstractEvaluationEngine {
	...
	public void evaluate(){
		for(List<Difference> testCaseDifferences : differences){
			...
			testCase.getEntries().addAll(createStatistics(testCaseDifferences));
	...
	public abstract List<AbstractTestCaseEntry> createStatistics(List<Difference> differences);
