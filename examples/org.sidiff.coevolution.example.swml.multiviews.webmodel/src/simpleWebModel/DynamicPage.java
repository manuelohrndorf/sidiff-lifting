 ...
 * </p>
 * <ul>
 *   <li>{@link simpleWebModel.DynamicPage#getShows <em>Shows</em>}</li>
 * </ul>
 *
 * @see simpleWebModel.SimpleWebModelPackage#getDynamicPage()
 * @model abstract="true"
 * @generated
 */
public interface DynamicPage extends Page {
	 ...
	 * @see #setShows(Entity)
	 * @see simpleWebModel.SimpleWebModelPackage#getDynamicPage_Shows()
	 * @model required="true"
	 * @generated
	 */
	Entity getShows();
	...
	/**
	 * Sets the value of the '{@link simpleWebModel.DynamicPage#getShows <em>Shows</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
