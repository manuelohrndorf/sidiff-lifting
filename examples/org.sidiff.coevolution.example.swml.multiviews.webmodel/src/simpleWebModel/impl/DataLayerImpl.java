 ...
 * </p>
 * <ul>
 *   <li>{@link simpleWebModel.impl.DataLayerImpl#getEntities <em>Entities</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataLayerImpl extends MinimalEObjectImpl.Container implements DataLayer {
	...
	protected EClass eStaticClass() {
		return SimpleWebModelPackage.Literals.DATA_LAYER;
	}
	...
	public EList<Entity> getEntities() {
		if (entities == null) {
			entities = new EObjectContainmentEList<Entity>(Entity.class, this, SimpleWebModelPackage.DATA_LAYER__ENTITIES);
		}
		return entities;
	}
