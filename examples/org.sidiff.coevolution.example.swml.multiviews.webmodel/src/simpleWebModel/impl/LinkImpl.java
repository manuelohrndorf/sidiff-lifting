 ...
 * </p>
 * <ul>
 *   <li>{@link simpleWebModel.impl.LinkImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkImpl extends MinimalEObjectImpl.Container implements Link {
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimpleWebModelPackage.LINK__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Page newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleWebModelPackage.LINK__TARGET, oldTarget, target));
	}
