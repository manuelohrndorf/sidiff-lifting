...
public class DatalayerFactoryImpl extends EFactoryImpl implements DatalayerFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DatalayerPackage.DATA_LAYER: return createDataLayer();
			case DatalayerPackage.ENTITY: return createEntity();
			case DatalayerPackage.REFERENCE: return createReference();
			case DatalayerPackage.ATTRIBUTE: return createAttribute();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case DatalayerPackage.SIMPLE_TYPE:
