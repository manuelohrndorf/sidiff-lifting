...
/**
 * This is the item provider adapter for a {@link org.sidiff.model.statemachine.StateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateMachineItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StateMachine_regions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StateMachine_regions_feature", "_UI_StateMachine_type"),
				 StatemachinePackage.Literals.STATE_MACHINE__REGIONS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addEventsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StateMachine_events_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StateMachine_events_feature", "_UI_StateMachine_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatemachinePackage.Literals.STATE_MACHINE__REGIONS);
