...
/**
 * This is the item provider adapter for a {@link simpleWebModel.AnnotatableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotatableElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AnnotatableElement_annotation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AnnotatableElement_annotation_feature", "_UI_AnnotatableElement_type"),
				 SimpleWebModelPackage.Literals.ANNOTATABLE_ELEMENT__ANNOTATION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((AnnotatableElement)object).getAnnotation();
