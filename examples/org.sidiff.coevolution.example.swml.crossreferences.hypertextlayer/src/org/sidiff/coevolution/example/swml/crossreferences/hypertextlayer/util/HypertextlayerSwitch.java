 ...
 * @generated
 */
public class HypertextlayerSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case HypertextlayerPackage.STATIC_PAGE: {
			...
			case HypertextlayerPackage.INDEX_PAGE: {
			...
			case HypertextlayerPackage.DATA_PAGE: {
			...
			case HypertextlayerPackage.LINK: {
