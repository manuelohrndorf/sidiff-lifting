 ...
 * </p>
 * <ul>
 *   <li>{@link org.sidiff.coevolution.example.swml.crossreferences.hypertextlayer.impl.DynamicPageImpl#getShows <em>Shows</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DynamicPageImpl extends PageImpl implements DynamicPage {
	...
	protected EClass eStaticClass() {
		return HypertextlayerPackage.Literals.DYNAMIC_PAGE;
	}
		...
		if (shows != null && shows.eIsProxy()) {
			...
			if (shows != oldShows) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HypertextlayerPackage.DYNAMIC_PAGE__SHOWS, oldShows, shows));
			}
		}
		return shows;
	}
	...
	public void setShows(Entity newShows) {
		...
		shows = newShows;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HypertextlayerPackage.DYNAMIC_PAGE__SHOWS, oldShows, shows));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HypertextlayerPackage.DYNAMIC_PAGE__SHOWS:
