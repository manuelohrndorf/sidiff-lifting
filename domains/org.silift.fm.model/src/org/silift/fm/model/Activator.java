...
public class Activator implements BundleActivator {
	...
	private Loader featureModelLoader = new AbstractEMFImporter() {
		...
		public String getLoaderDescription() {
			return "Loader for Feature models";
		}
	};
	...
	public void start(BundleContext context) throws Exception {
		...
		ModelStorage.getInstance().registerLoader(featureModelLoader);
	}

	@Override
	public void stop(BundleContext context) throws Exception {
		ResourceUtil.unregisterClassLoader(Activator.class.getClassLoader());
		ModelStorage.getInstance().releaseLoader(featureModelLoader);
	}
