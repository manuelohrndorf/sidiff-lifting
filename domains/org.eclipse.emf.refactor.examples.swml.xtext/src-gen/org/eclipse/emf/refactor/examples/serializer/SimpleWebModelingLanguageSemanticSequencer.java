...
public class SimpleWebModelingLanguageSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Link(ISerializationContext context, Link semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getLinkAccess().getTargetPageIDTerminalRuleCall_1_0_1(), semanticObject.eGet(SimpleWebModelingLanguagePackage.Literals.LINK__TARGET, false));
		feeder.finish();
	}
	...
	protected void sequence_Reference(ISerializationContext context, Reference semanticObject) {
		...
		feeder.accept(grammarAccess.getReferenceAccess().getTypeEntityIDTerminalRuleCall_3_0_1(), semanticObject.eGet(SimpleWebModelingLanguagePackage.Literals.REFERENCE__TYPE, false));
		feeder.finish();
	}
