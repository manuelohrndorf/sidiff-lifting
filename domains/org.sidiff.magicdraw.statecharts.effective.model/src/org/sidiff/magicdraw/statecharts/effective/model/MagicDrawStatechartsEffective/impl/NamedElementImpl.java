...
public abstract class NamedElementImpl extends MinimalEObjectImpl.Container implements NamedElement {
	...
	protected EClass eStaticClass() {
		return MagicDrawStatechartsEffectivePackage.Literals.NAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MagicDrawStatechartsEffectivePackage.NAMED_ELEMENT__NAME, oldName, name, !oldNameESet));
	}
	...
	public void unsetName() {
		...
		nameESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MagicDrawStatechartsEffectivePackage.NAMED_ELEMENT__NAME, oldName, NAME_EDEFAULT, oldNameESet));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 MagicDrawStatechartsEffectiveValidator.NAMED_ELEMENT__HAS_QUALIFIED_NAME,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 MagicDrawStatechartsEffectiveValidator.DIAGNOSTIC_SOURCE,
						 MagicDrawStatechartsEffectiveValidator.NAMED_ELEMENT__HAS_NO_QUALIFIED_NAME,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 MagicDrawStatechartsEffectiveValidator.DIAGNOSTIC_SOURCE,
						 MagicDrawStatechartsEffectiveValidator.NAMED_ELEMENT__VISIBILITY_NEEDS_OWNERSHIP,
	 ...
	 * @generated
	 */
	public void createDependency(NamedElement supplier) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case MagicDrawStatechartsEffectivePackage.NAMED_ELEMENT___HAS_QUALIFIED_NAME__DIAGNOSTICCHAIN_MAP:
				return has_qualified_name((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case MagicDrawStatechartsEffectivePackage.NAMED_ELEMENT___HAS_NO_QUALIFIED_NAME__DIAGNOSTICCHAIN_MAP:
				return has_no_qualified_name((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case MagicDrawStatechartsEffectivePackage.NAMED_ELEMENT___VISIBILITY_NEEDS_OWNERSHIP__DIAGNOSTICCHAIN_MAP:
				return visibility_needs_ownership((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case MagicDrawStatechartsEffectivePackage.NAMED_ELEMENT___CREATE_DEPENDENCY__NAMEDELEMENT:
				createDependency((NamedElement)arguments.get(0));
				return null;
			case MagicDrawStatechartsEffectivePackage.NAMED_ELEMENT___CREATE_USAGE__NAMEDELEMENT:
				createUsage((NamedElement)arguments.get(0));
				return null;
			case MagicDrawStatechartsEffectivePackage.NAMED_ELEMENT___GET_LABEL:
				return getLabel();
			case MagicDrawStatechartsEffectivePackage.NAMED_ELEMENT___GET_LABEL__BOOLEAN:
				return getLabel((Boolean)arguments.get(0));
			case MagicDrawStatechartsEffectivePackage.NAMED_ELEMENT___ALL_NAMESPACES:
