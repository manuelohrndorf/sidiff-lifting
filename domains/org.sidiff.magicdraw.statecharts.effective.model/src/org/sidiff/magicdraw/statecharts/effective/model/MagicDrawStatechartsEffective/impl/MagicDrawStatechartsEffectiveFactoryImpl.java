 ...
 * @generated
 */
public class MagicDrawStatechartsEffectiveFactoryImpl extends EFactoryImpl implements MagicDrawStatechartsEffectiveFactory {
	/**
	 ...
	 * @generated
	 */
	public static MagicDrawStatechartsEffectiveFactory init() {
		try {
			MagicDrawStatechartsEffectiveFactory theMagicDrawStatechartsEffectiveFactory = (MagicDrawStatechartsEffectiveFactory)EPackage.Registry.INSTANCE.getEFactory(MagicDrawStatechartsEffectivePackage.eNS_URI);
			if (theMagicDrawStatechartsEffectiveFactory != null) {
				return theMagicDrawStatechartsEffectiveFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new MagicDrawStatechartsEffectiveFactoryImpl();
	}
	 ...
	 * @generated
	 */
	public MagicDrawStatechartsEffectiveFactoryImpl() {
		super();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case MagicDrawStatechartsEffectivePackage.PROTOCOL_STATE_MACHINE: return createProtocolStateMachine();
			case MagicDrawStatechartsEffectivePackage.STATE_MACHINE: return createStateMachine();
			case MagicDrawStatechartsEffectivePackage.PSEUDOSTATE: return createPseudostate();
	 ...
	 * @generated
	 */
	public MagicDrawStatechartsEffectivePackage getMagicDrawStatechartsEffectivePackage() {
		return (MagicDrawStatechartsEffectivePackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static MagicDrawStatechartsEffectivePackage getPackage() {
		return MagicDrawStatechartsEffectivePackage.eINSTANCE;
	}

} //MagicDrawStatechartsEffectiveFactoryImpl
