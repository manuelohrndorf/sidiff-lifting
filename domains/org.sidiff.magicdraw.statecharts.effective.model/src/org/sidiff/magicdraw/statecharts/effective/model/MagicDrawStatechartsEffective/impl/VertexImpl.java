 ...
 * <ul>
 *   <li>{@link org.sidiff.magicdraw.statecharts.effective.model.MagicDrawStatechartsEffective.impl.VertexImpl#getContainer <em>Container</em>}</li>
 *   <li>{@link org.sidiff.magicdraw.statecharts.effective.model.MagicDrawStatechartsEffective.impl.VertexImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link org.sidiff.magicdraw.statecharts.effective.model.MagicDrawStatechartsEffective.impl.VertexImpl#getOutgoing <em>Outgoing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class VertexImpl extends NamedElementImpl implements Vertex {
	...
	protected EClass eStaticClass() {
		return MagicDrawStatechartsEffectivePackage.Literals.VERTEX;
	}
	...
	public Region getContainer() {
		if (eContainerFeatureID() != MagicDrawStatechartsEffectivePackage.VERTEX__CONTAINER) return null;
	...
	public NotificationChain basicSetContainer(Region newContainer, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newContainer, MagicDrawStatechartsEffectivePackage.VERTEX__CONTAINER, msgs);
		return msgs;
	}
	...
	public void setContainer(Region newContainer) {
		if (newContainer != eInternalContainer() || (eContainerFeatureID() != MagicDrawStatechartsEffectivePackage.VERTEX__CONTAINER && newContainer != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MagicDrawStatechartsEffectivePackage.VERTEX__CONTAINER, newContainer, newContainer));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case MagicDrawStatechartsEffectivePackage.VERTEX___CONTAINING_STATE_MACHINE:
				return containingStateMachine();
			case MagicDrawStatechartsEffectivePackage.VERTEX___GET_INCOMINGS:
				return getIncomings();
			case MagicDrawStatechartsEffectivePackage.VERTEX___GET_OUTGOINGS:
				return getOutgoings();
		}
