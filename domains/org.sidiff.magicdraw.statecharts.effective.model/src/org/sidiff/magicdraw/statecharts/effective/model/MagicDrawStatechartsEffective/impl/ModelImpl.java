 ...
 * <ul>
 *   <li>{@link org.sidiff.magicdraw.statecharts.effective.model.MagicDrawStatechartsEffective.impl.ModelImpl#getViewpoint <em>Viewpoint</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	protected EClass eStaticClass() {
		return MagicDrawStatechartsEffectivePackage.Literals.MODEL;
	}
	...
	public void setViewpoint(String newViewpoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MagicDrawStatechartsEffectivePackage.MODEL__VIEWPOINT, oldViewpoint, viewpoint, !oldViewpointESet));
	}
	...
	public void unsetViewpoint() {
		...
		viewpointESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MagicDrawStatechartsEffectivePackage.MODEL__VIEWPOINT, oldViewpoint, VIEWPOINT_EDEFAULT, oldViewpointESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MagicDrawStatechartsEffectivePackage.MODEL__VIEWPOINT:
				return getViewpoint();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case MagicDrawStatechartsEffectivePackage.MODEL___IS_METAMODEL:
				return isMetamodel();
		}
