package org.sidiff.marte.difference.technical;
...
public class TechnicalDifferenceBuilderMARTE extends TechnicalDifferenceBuilder {
	...
	public String getDocumentType() {
		return MARTEPackage.eNS_URI;
	}
	
	@Override
	public String getName(){	
		return "TechnicalDifference Builder for MARTE";
	}
}
