package org.sidiff.henshin.editrules.atomic;
...
public class RuleBaseProject extends AbstractRuleBaseProject {
	...
	public String getName() {
		return "SiDiff Domain - Atomic Edit Rules for Henshin (2018-06-06 12:27:28)";
	}
	
	@Override
	public Set<String> getDocumentTypes() {
		Set<String> types = new HashSet<String>();
		types.add("http://www.eclipse.org/emf/2011/Henshin");
