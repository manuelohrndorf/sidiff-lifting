...
/**
 * Rule generator which constructs a Henshin rule from a pair of models
 * (original model and changed model).
 * 
...
public class ExampleBasedRuleGenerator {
	...
	/**
	 * Constructs a Henshin rule from a pair of models (original model and
	 * changed model).
	 * 
	 * @param ruleName
	 * @param pathA
	...
	/**
	 * Traverses the matching, converts all eObjects to graph nodes and adds a
	 * LHS-RHS mapping between those nodes.
	 */
	...
	/**
	 * Create a Henshin node for the given EObject and adds it to the given
	 * Henshin graph.
	 * 
	 * @param graph
	 * @param obj
	...
	/**
	 * Creates a Henshin edge representing the given reference in the Henshin
	 * graph. To that end, the Henshin nodes corresponding to the given source
	 * and target EObjects are obtained from the trace map model2Graph.
	 * 
	 * @param model2Graph
	 * @param srcObj
	 * @param tgtObj
