package org.sidiff.vcmsintegration.preferences.util;
...
public class SettingsFactory {
	...
	/**
	 * Array to hold all the registered extensions
	 */
	 ...
	 */
	private ArrayList<ISiDiffSettingsFactory> extensionClassList;
	...
	private SettingsFactory() {
		...
		extensionClassList = new ArrayList<ISiDiffSettingsFactory>();
		...
		for (IConfigurationElement element : extensionList) {
			ISiDiffSettingsFactory temp;
			try {
				temp = ((ISiDiffSettingsFactory) element.createExecutableExtension("class"));
	...
	/**
	 * Checks if the required plugins are installed and returns a {@link org.sidiff.vcmsintegration.preferences.matching.factory.MatchingSettingsFactory}.
	 ...
	 * @return An instance of a {@link org.sidiff.vcmsintegration.preferences.matching.factory.MatchingSettingsFactory}
	...
	/**
	 * Checks if the required plugins are installed and returns a {@link org.sidiff.vcmsintegration.preferences.difference.factory.DifferenceSettingsFactory}.
	 * Capable of using local settings.
	 * @param documentType Document Type {@link String} of the model to be processed.
	 * @param store The {@link IPreferenceStore} to load the preference values from.
	 * @param resource The {@link IResource} of the model to be processed
	 * @return An instance of a {@link org.sidiff.vcmsintegration.preferences.difference.factory.DifferenceSettingsFactory}
	 * @throws UnsupportedFeatureLevelException Thrown if the required plugins are not installed.
	 */
	...
	/**
	 * Checks if the required plugins are installed and returns a {@link org.sidiff.vcmsintegration.preferences.lifting.factory.LiftingSettingsFactory}.
	 * @param documentType Document Type {@link String} of the model to be processed.
	 * @param store The {@link IPreferenceStore} to load the preference values from.
	 * @return An instance of a {@link org.sidiff.vcmsintegration.preferences.lifting.factory.LiftingSettingsFactory}
	 * @throws UnsupportedFeatureLevelException Thrown if the required plugins are not installed.
	 */
	...
	/**
	 * Checks if the required plugins are installed and returns a {@link org.sidiff.vcmsintegration.preferences.patching.factory.PatchingSettingsFactory}.
	 * @param documentType Document Type {@link String} of the model to be processed.
	 * @param store The {@link IPreferenceStore} to load the preference values from.
	 * @return An instance of a {@link org.sidiff.vcmsintegration.preferences.patching.factory.PatchingSettingsFactory}
	 * @throws UnsupportedFeatureLevelException Thrown if the required plugins are not installed.
	 */
	...
	private void getAllExtensions() {
		extensionList = Platform.getExtensionRegistry().getConfigurationElementsFor("org.sidiff.vcmsintegration.preferences.settingsFactory"); 
	}
