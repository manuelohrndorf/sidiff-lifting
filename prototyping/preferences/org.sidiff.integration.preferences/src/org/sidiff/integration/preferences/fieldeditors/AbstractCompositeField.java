 ...
 *
 */
public abstract class AbstractCompositeField extends PreferenceField {
	...
	public AbstractCompositeField(String preferencePrefix, String title) {
		...
		this.fields = new ArrayList<PreferenceField>();
	}
	...
	public void addField(PreferenceField field) {
		...
		if(prefix != null) {
			field.setPreferenceName(prefix + ":" + field.getPreferenceName());
		}
		fields.add(field);
	}
}
