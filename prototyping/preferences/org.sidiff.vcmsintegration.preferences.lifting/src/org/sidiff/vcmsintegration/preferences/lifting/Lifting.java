 ...
 */
public class Lifting implements ISiDiffEnginesPreferenceTab {
	...
	public Iterable<PreferenceField> getTabContent() {
		...
		recognitionEngineModes = RadioBoxPreferenceField.createFromArray("recognitionEngineModes", "Recognition Engine Modes Services", RecognitionEngineMode.values(), new ValueAndLabelProvider<RecognitionEngineMode>() {
			@Override public String[] get(RecognitionEngineMode input) { return new String[]{ input.toString(), input.toString() }; }
		});
