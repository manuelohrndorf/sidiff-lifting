...
public class MatchImpl extends AssignmentImpl implements Match {
	...
	public void setParameterValue(Parameter param, Object value) {
		...
		// // TODO: --> BEGIN: Review <-- Not mandatory because ParameterList is not an EObject. But I think its cleaner this way.
		if (name != null && nodes != null
				&& (value == null || value instanceof EObject)
				&& !(value instanceof ParameterList<?>)) {
			// TODO: --> END: Review <--	
			for (Node node : nodes) {
