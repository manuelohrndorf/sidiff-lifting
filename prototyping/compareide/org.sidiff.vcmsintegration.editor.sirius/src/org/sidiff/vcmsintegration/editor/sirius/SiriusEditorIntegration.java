package org.sidiff.vcmsintegration.editor.sirius;
...
public class SiriusEditorIntegration extends AbstractEditorIntegration {
	...
	public URI copyDiagram(URI modelFile, String savePath) throws FileNotFoundException {
		...
		try {
			...
			final URI diagramSaveFile = EMFStorage.pathToUri(savePath + separator + resource.getURI().lastSegment());
