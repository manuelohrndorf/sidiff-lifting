...
public class NameMapper {
	...
	private void initSAMappings(){
		...
		mappings.add(new NameMapping("CREATE_MechanicDevice_IN_Architecture_(component)","createMechanicDevice"));
		...
		mappings.add(new NameMapping("DELETE_MechanicDevice_IN_Architecture_(component)","deleteMechanicDevice"));
		...
		mappings.add(new NameMapping("SET_ATTRIBUTE_Actuator_Power_supply","setActuatorPower_supply"));
		...
		mappings.add(new NameMapping("SET_ATTRIBUTE_ElectronicDevice_Power_supply","setElectronicDevicePower_supply"));
		mappings.add(new NameMapping("SET_ATTRIBUTE_HardwareComponent_Name","setHardwareComponentName"));
		mappings.add(new NameMapping("SET_ATTRIBUTE_HardwareComponent_Power_supply","setHardwareComponentPower_supply"));
		mappings.add(new NameMapping("SET_ATTRIBUTE_MechanicDevice_Name","setMechanicDeviceName"));
		mappings.add(new NameMapping("SET_ATTRIBUTE_MechanicDevice_Power_supply","setMechanicDevicePower_supply"));
		...
		mappings.add(new NameMapping("SET_ATTRIBUTE_Sensor_Power_supply","setSensorPower_supply"));
