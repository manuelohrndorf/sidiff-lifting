...
public class Common {
	...
	public static EClassifier resolveStringAsEClassifier(String eClassifierName, Stack<EPackage> ePackagesStack)
			...
			if (!ea.isDerived() && !ea.isTransient() && ea.isChangeable()) {
				...
				if (createNotRequiredAndNotIDAttributes || !createNotRequiredAndNotIDAttributes
					...
					HenshinRuleAnalysisUtilEx.createCreateAttribute(inEClassNode, ea,
							Common.toCamelCase(getFreeAttributeName(eaName, rule)));
				}
			}
		}
	...
	/**
	 * Creates a rule inside a module containing with Nodes and Edges for the
	 * EClassifiers and EReferences given as arguments. How the Nodes and Edges
	 * are created depends on the OperationType. The result is a basic rule that
	...
	/**
	 * Creates an inverse of a module. E.g. DELETE for CREATE or REMOVE for ADD
	 * etc.
	 * 
	 * @param module
	 * @param operationType
	 ...
	 * @throws OperationTypeNotImplementedException
	 */
	public static Module createInverse(Module module, OperationType inputOperationType)
			throws OperationTypeNotImplementedException {
