...
public class TypeReplacer_old {
	 ...
	 */
	public TypeReplacer_old(Module originalModule, OperationType opType, boolean reduceToSuperType) throws OperationTypeNotImplementedException {
