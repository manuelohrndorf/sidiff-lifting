...
public class MoveDownGenerator {
	 ...
	 * @param newContext
	 */
	public MoveDownGenerator(EClassifier eClassifier, EReference eReference,
	...
	public Module generate() throws OperationTypeNotImplementedException {
		...
		// create rule
		ModuleInternalsApplicator.createBasicRule(MOVE_DOWN_Module, eReference, eClassifier, oldContext, eReference, newContext, OperationType.MOVE_DOWN);
